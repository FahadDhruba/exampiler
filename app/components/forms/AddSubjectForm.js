                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <div className="p-4">
                            ...
                            <label htmlFor="subNameInput" className="block text-sm font-medium text-gray-900 dark:text-white">Subject Name English</label>
                            <input
                                type="text"
                                id='subNameInput'
                            ...
                            />
                            <label htmlFor="subNameInputBn" className="block text-sm font-medium text-gray-900 dark:text-white">Subject Name Bangla</label>
                            <input
                                type="text"
                                id='subNameInputBn'
