                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <div className="p-4">
                            ...
                            <div>
                                <label htmlFor="paperNameInput" className="block text-sm font-medium text-gray-900">Paper Name English</label>
                                <input
                                    type="text"
                                    id="paperNameInput"
                            ...
                            <div>
                                <label htmlFor="paperNameInputBn" className="block text-sm font-medium text-gray-900">Paper Name Bangla</label>
                                <input
                                    type="text"
                                    id="paperNameInputBn"
