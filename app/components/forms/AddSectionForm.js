            ...
            {showPopup && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        ...
                        {/* Section Form */}
                        <div className="p-4">
                            <label htmlFor="sectionInput" className="block text-sm font-medium text-gray-900 dark:text-white">Section Name English</label>
                            <input
                                type="text"
                                id='sectionInput'
                            ...
                            />
                            <label htmlFor="sectionInputBn" className="block text-sm font-medium text-gray-900 dark:text-white">Section Name Bangla</label>
                            <input
                                type="text"
                                id='sectionInputBn'
